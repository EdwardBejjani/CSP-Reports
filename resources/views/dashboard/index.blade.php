                ...
                <div class="row row-cols-3 mt-3 mx-3">
                    <div class="col">
                        <div class="card-glass-dark p-4 d-flex flex-column align-items-center justify-content-center"
                            style="height: 40vh;">
                            <h3 class="text-white text-shadow text-center fw-bold"><i class="fa fa-user-plus fa-2x mb-2"></i><br>New
                                Users</h3>
                            <h1 class="text-white text-shadow text-center fw-bold" style="font-size: 72pt;">{{ count($new_users) }}
                            </h1>
                        </div>
                    </div>
                    <div class="col">
